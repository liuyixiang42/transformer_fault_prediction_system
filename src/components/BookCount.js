...
import { bookCount } from "../services/bookService";
...
class BookCount extends React.Component {
  ...
  handleOnClick = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      bookCount(values.dateRange[0]._d, values.dateRange[1]._d, callback);
    });
  };
  render() {
...
const WrappedBookCount = Form.create({ name: "count" })(BookCount);

export default WrappedBookCount;
